...
{
    public partial class Login : BJ.AspxTask.WebPageBase
    {
        private const string cookiesName = "CTQS_V2_UserName";
        ...
        private void LoginStart()
        {
            try
            {
                ...
                if (oper != null)
                {
                    ...
                    Inphase.Project.CTQS.Common.WriteCookies(BJ.SystemWebFormulation.SystemWebFormulation.Parameter("OperatorId"),
                                        oper.OperatorId);
                    ...
                    BJ.SysLog.Descent.SysLog.Add(oper.OperatorId, BJ.SysLog.Descent.SysLog.LogMode.Insert,
                         BJ.SysLog.Descent.SysLog.LogItemID.AreaManage, "登录成功！", oper.Client_IP);
                    return;
                }
                else
                {

...
namespace Inphase.Project.CTQS.Descent
{
    ...
    public partial class AreaInfo : BJ.AspxTask.WebPageBase
    {
       ...
       private void InitAreaTree()
       {
           ...
           TreeNode root = new TreeNode("四川省", "1");
        ...
        protected void buttonEdit_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                area.Update();
                BJ.DTIMS.Common.Common.ScriptManagerRegister(this.UpdatePanel1, JqueryComm.ShowMessage("提示", "修改成功！", MessageType.info));
            ...
            {
                BJ.DTIMS.Common.Common.ScriptManagerRegister(this.UpdatePanel1, JqueryComm.ShowMessage("提示", "修改失败！" + ex.Message, MessageType.error));
            }
        }
	}
}

<%@ Page Language="c#" Inherits="Inphase.Project.CTQS.Descent.LogInfo" Codebehind="LogInfo.aspx.cs" %>
    ...
    <form  method="post" enctype="multipart/form-data" id="Form1" style="margin-left:-8px" runat="server">
        <div>
            <table visible="false" border="0" width="100%" align="center" cellpadding="0" cellspacing="0"
                ...
                <tr>
                    <td class="header" style="width:200px" align="center">
                        日志ID：</td>
                    <td>
                        <asp:Label ID="labelLogID" runat="server" Width="156px"></asp:Label></td>
                    <td class="header" align="center" style="width:150px" nowrap>
                        记录项目名称：</td>
                ...
                <tr>
                    <td height="26" align="center" class="header">
                        操作方式：</td>
                    <td>
                ...
                <tr>
                    <td class="header" style="height: 56px" align="center">
                        日志内容：</td>

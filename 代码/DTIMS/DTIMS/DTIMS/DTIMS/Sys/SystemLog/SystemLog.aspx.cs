...
using BJ.WebTools;						//为了实现过滤条引用的命名空间
...
namespace Inphase.Project.CTQS.Descent
{
    ...
    /// SystemLog 的摘要说明。
    /// </summary>
    public partial class SystemLog : BJ.AspxTask.WebPageBase
    {
            ...
            else
            {
                ...
                if (temp != null && temp != "")
                {
                    ...
                    if (temp == "a")
                    {
                        try
                        {
                            BJ.SysLog.Descent.SysLog.Delete();
                            BJ.SysLog.Descent.SysLog.Add(this.Oper.OperatorId,
                                 BJ.SysLog.Descent.SysLog.LogMode.Delete,
                                 BJ.SysLog.Descent.SysLog.LogItemID.SyslogManage, "管理员：" + this.Oper.OperName + "，删除所有日志信息！", oper.Client_IP);
                            //this.DoBind();
                            return;
                        }
                        catch (Exception et)
        ...
        //        {
        //            string msg = Inphase.CTQS.Common.JqueryComm.ShowMessage("错误", "起始日期必需小于结束日期", MessageType.error);
        //            Inphase.CTQS.Common.Common.ScriptManagerRegister(this.UpdatePanel1, msg);
        //            //this.DataGridUserPort.DataSource = null;
        //            //this.DataGridUserPort.DataBind();
        //            Inphase.CTQS.Common.Common.RenderEmptyGridView(this.grdLog);
        //            return;
        //        }
        //    }
        //    #endregion
        ...
        //    DataTable dt = SysLog.GetDataTable(page_rows, CurrentPageIndex(), GetOrderBy(), 
        ...
        //    //    if (dt.Rows.Count == 0)
        //    //    {
        //    //        this.DataGridUserPort.CurrentPageIndex = 0;
        //    //    }
        //    //    else
        //    //    {
        //    //        while ((dt.Rows.Count <= this.DataGridUserPort.PageSize * this.DataGridUserPort.CurrentPageIndex) && dt.Rows.Count != 0)
        //    //        {
        //    //            this.DataGridUserPort.CurrentPageIndex--;
        //    //        }
        //    //    }
        //    //    if ((dt.Rows.Count) % (DataGridUserPort.PageSize) == 0)
        //    //    {
        //    //        if (DataGridUserPort.CurrentPageIndex > (dt.Rows.Count / DataGridUserPort.PageSize - 1))
        //    //        {
        //    //            if (DataGridUserPort.CurrentPageIndex > 0)
        //    //            {
        //    //                DataGridUserPort.CurrentPageIndex = DataGridUserPort.PageCount - 2;
        //    //            }
        //    //        }
        //    //    }
        //    //}
        ...
        //    //this.DataGridUserPort.DataSource = dt.DefaultView;
        //    //this.DataGridUserPort.DataBind();

        //    ////在绑定前必须加入过滤语句
        //    //// this.fi.Filter();
        //    //max_page_num = (data_rows - 1) / 15 + 1;
        //    ////设置页面显示总条数
        ...
        //private void DataGridUserPort_ItemDataBound(object sender, System.Web.UI.WebControls.DataGridItemEventArgs e)
        //{
        //    if (e.Item.ItemIndex > -1)
        //    {
        //        System.Web.UI.WebControls.Image lb = new System.Web.UI.WebControls.Image();
        //        lb.ImageUrl = "../../Images/Common/view.gif";
        //        lb.Attributes.Add("style", "cursor:hand");
        //        lb.Attributes.Add("onClick", "return DoView('LogInfo.aspx?num=" + e.Item.Cells[0].Text + "&from=a&rad='+Math.random());");
        //        lb.ToolTip = "查看";

        //        e.Item.Cells[this.DataGridUserPort.Columns.Count - 1].Controls.Add(lb);
        //    }
        //}
        ...
        //private void DataGridUserPort_PageIndexChanged(object source, System.Web.UI.WebControls.DataGridPageChangedEventArgs e)
        //{
        //    this.DataGridUserPort.CurrentPageIndex = e.NewPageIndex;
        //    this.DoBind();
        //}

        //private void DataGridUserPort_SortCommand(object source, System.Web.UI.WebControls.DataGridSortCommandEventArgs e)
        //{
        //    //实现正反向排序
        ...
        //private void DataGridUserPort_PreRender(object sender, System.EventArgs e)
        //{
        //    foreach (DataGridItem dgi in this.DataGridUserPort.Items)
        //    {
        //        if (dgi.Cells[5].Text.Length > 40)
        //        {
        //            dgi.Cells[5].Text = dgi.Cells[5].Text.Substring(0, 40);
        //        }
        //    }
        //}

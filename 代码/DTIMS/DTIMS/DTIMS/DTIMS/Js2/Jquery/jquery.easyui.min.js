...
(function ($) {
    ...
    // 修改：添加“,fn,_cr”
    function _205(_206, _207, _208, fn, _cr) {
        var win = $("<div class=\"messager-body\"></div>").appendTo("body");
        win.append(_207);
        if (_208) {
            var tb = $("<div class=\"messager-button\"></div>").appendTo(win);
            for (var _209 in _208) {
                // 修改：在“javascript:void(0)”后添加“;”
    ...
    $.messager = { show: function (_20a) {
        ...
        // 修改：添加“,fn,_cr2”
        var win = _205(_20e, _20f, _210, fn, _cr2);
        ...
        // 修改：添加“,fn”
        var win = _205(_211, _212, _213, fn);
        ...
        var _215 = { bar: function () {
            ...
            // 修改：添加“>div.messager-progress”“win=win.parent();”
            var win = $("body>div.messager-window>div.messager-body>div.messager-progress");
            win = win.parent();
            if (win.length) {
                if (win[0].timer) {

<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Main.aspx.cs" Inherits="DTIMS.Web.Main" %>
    ...
    <script type="text/javascript">
        ...
        function userOper(name) {
            if (name == "登录") {
                ...
                window.open("Help/Help.html", "JFIMS_V2_帮助");
            }
            else {
...
<body class="easyui-layout">
    ...
    <div region="north" border="false" style="height: 65px; overflow: hidden; background-image: url(../../Images3/maintopright.png);
        background-repeat: repeat-x;">
        <div id="topInnerBox" style="overflow: hidden;">
            <img src="../../Images3/maintop.jpg" width="998" height="65" alt="logo" />
    ...
    <div region="center" id="MainContainer" title='<%= this.CreateUserMenu() %>'>
        <div id="tt" class="easyui-tabs" fit="true" border="false" plain="true" style="background: url(../../Images3/Main/maintopright.png) no-repeat left bottom;">

...
<head runat="server">
    ...
    <style type="text/css">
        body {
            ...
            background-image: url(../../Images3/bjnote3.jpg);
        }
    ...
    <style>
        body {
            ...
            padding: 0px;
            background-repeat: repeat-x;
            background-image: url(Images3//bj.png);*/
            /*width:100%;
...
<body>
        <form id="Form1" runat="server" method="post" name="Form1">
            ...
            <table width="48%" height="110%" border="0" align="center" style=" background-position: -260px -96px;" cellpadding="0" cellspacing="0" background="../../Images3/dcLog.png">
                <%-- --%>
                <tr>
                    <td id="auto-style1" class="auto-style1">&nbsp;&nbsp;&nbsp;&nbsp;
                    <table width="48%" border="0" align="center" cellpadding="0" cellspacing="0" background="../../Images3/dcLog.png">
                        <tr>
                            <td>
                                <%-- <img src="Images/Login/log.png" width="80px" height="80px" />--%>
                            </td>
                    ...
                    <td class="auto-style2">
                        <table width="280" border="0" style="text-align: center; margin-top: 10%; margin-left: 60px" cellpadding="0" cellspacing="0">

                            <tr>
                                <td height="60" colspan="2" valign="bottom">
                                    <p>
                                        <span class="STYLE2">登录名：</span><span style="text-align: left;">
                                        ...
                                        type="text" size="20" tabindex="0" style="width: 175px; height: 15px;color:#ff6600;" />--%>
                                            <asp:DropDownList ID="textUserName" Style="width: 179px; height: 21px; color: #ff6600;" runat="server">
                                            </asp:DropDownList>
                                        </span>
                                    </p>
                                </td>
                            ...
                            <tr style="align-content:center">
                                ...
                                <td width="220" align="center" style=""><a href="javascript:void(0);" id="aLogin" class="easyui-linkbutton" onclick="return doSubmit();"
                                    icon="icon-login">登 录</a></td>
                            </tr>
                            <tr>
                                <td height="60px" colspan="2"><span class="input-label"><span style="text-align: left;"></span></span></td>
                            </tr>
                        </table>
                    </td>
                </tr>
            ...
            <table width="985" border="0" align="center" cellpadding="0" cellspacing="0">
                <%--background="Images/Login/login_03.gif"--%>
                <tr>
                    <td>&nbsp;</td>
                </tr>
            </table>

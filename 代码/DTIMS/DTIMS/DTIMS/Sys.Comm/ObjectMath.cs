...
namespace BJ.WebTools
{
	...
	public class ObjectMath
	{
		...
		public static void DataBindSort(System.Web.UI.WebControls.DataGridSortCommandEventArgs e,
			...
			System.Web.UI.WebControls .DataGrid dg,DataTable dt,BJ.WebTools.DataGridFilter dgf)
		{
			//实现正反向排序
		...
		public static void DataBind(object _sort,System.Web.UI.WebControls .DataGrid dg,DataTable dt,BJ.WebTools .DataGridFilter dgf)
		{
			//绑定数据				

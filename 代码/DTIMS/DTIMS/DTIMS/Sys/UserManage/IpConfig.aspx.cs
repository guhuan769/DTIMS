...
namespace DTIMS.Web
{
    ...
    /// </summary>
    public partial class IpConfig : WebPageBase
    {
        ...
        protected void btnOk_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                oldPwd = Sys.Comm.EnDeCrypt.Encrypt(oldPwd);//将旧密码加密
                ...
                newPwd = Sys.Comm.EnDeCrypt.Encrypt(newPwd);//将新密码加密
                opper.OPER_Password = newPwd;
                opper.ChangePassword(this.MainDataBaseName, newPwd);

                DTIMS.DataAcess.Common.SysLog.Add(this.Oper.OperatorId, DTIMS.DataAcess.Common.SysLog.LogMode.UpDate, DTIMS.DataAcess.Common.SysLog.LogItemID.OperatorManage, "密码修改成功！", this.Oper.Client_IP);
            ...
            {
                DTIMS.DataAcess.Common.SysLog.Add(this.Oper.OperatorId, DTIMS.DataAcess.Common.SysLog.LogMode.UpDate, DTIMS.DataAcess.Common.SysLog.LogItemID.OperatorManage, string.Concat("密码修改失败！", et.Message), this.Oper.Client_IP);
                DTIMS.Comm.Common.ScriptManagerRegister(this.UpdatePanel1, JqueryComm.ShowMessage("错误", "修改错误，详细：" + et.Message, MessageType.error));
            }
        }
    }
}

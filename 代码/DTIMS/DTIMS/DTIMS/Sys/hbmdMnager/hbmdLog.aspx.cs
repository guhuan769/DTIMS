...
namespace DTIMS.Web
{
    ...
    /// SystemLog 的摘要说明。
    /// </summary>
    public partial class hbmdLog : WebPageBase
    {
        ...
        private void DoBind()
        {
            ...
            //科目
            string subject = this.subject.SelectedValue;

            int cur_page_index = 0;
            DataTable dt = DTIMS.DataAcess.Common.SysLog.GetDataHbmdLogTable(page_rows, CurrentPageIndex(), " P.PASSTIME DESC",
               this.txtStart.Value, this.dtpkEndDate.Value, Convert.ToInt32(this.hbMdBtn.SelectedValue), out data_rows, out cur_page_index,subject);
        ...
        public static string ExcelJson(string starttime, string endtime)
        {
            ...
            DTIMS.DataAcess.Common.SysLog.GetSubjectLog(999999999, 1, " ID DESC",
           starttime, endtime, 0, out data_rowss, out cur_page_indexs);
            ...
            foreach (DataRow dataRow in dt.Rows)
            {
                ...
                foreach (DataColumn dataColumn in dt.Columns)
                {
                    ...
                    //    dataRowColunName = dataRow[dataColumn.ColumnName].ToString();
                    //}
                    if (dataColumn.ColumnName.Equals("PASSTIME"))
                    {
                        ColunName = "日期";
                        dataRowColunName = dataRow[dataColumn.ColumnName].ToString();
                    }

...
namespace BJ.OperatorPersistent.Descent
{
    /// <summary>
    /// 人员类的持久化操作
    /// 人员类与页面上相关的提供的方法,
    ...
    public class OperatorPersistent
    {
        ...
        public void SetRoleGroup(string operId, ArrayList list)
        {
            ...
            DbTransaction trans;
            DbCommand cmdSelect;
            Database dataBase = DatabaseFactory.CreateDatabase(BJ.SystemWebFormulation.SystemWebFormulation.Parameter("MainDataBaseName"));
        ...
        private static DataTable GetMainAreaInfo()
        {
            DataTable dt = null;
            DbCommand cmdSelect = null;
            Microsoft.Practices.EnterpriseLibrary.Data.Database mDataBase = DatabaseFactory.CreateDatabase(BJ.SystemWebFormulation.SystemWebFormulation.Parameter("MainDataBaseName"));

...
namespace BJ.Role.Descent
{
    ...
    public class RoleGroup
    {
        ...
        {
            BJ.OperatorPersistent.Descent.OperatorPersistent oper = new BJ.OperatorPersistent.Descent.OperatorPersistent();
        ...
        /// <returns></returns>
        //public DataTable ListAll(bool isPublic, Inphase.Project.)
        //{

...
var customerDialog = function(title,isCloseButton)
{
   ...
   var divStr = function()
   {
        return "<div id=\""+divObjID+"\" icon=\"icon-save\" style=\"width:700px;height:500px;\"></div>";
   }
   ...
   {
        $('.panel-title').html("数据加载中，请稍后...");
	    $(_divObj).find(".dialog-content").html(iframeStr(url,option));
	    setOption(option);
	    //隐藏，当页面内容加载完成再显示出来
	    //$("#dialog-iframe").fadeTo("fast", 0);
	    
	    $("#" + dialogID).bind("load",function(){
	        $('.panel-title').html(_title);
	    }); 
        $(_divObj).dialog('open'); 
   } 
   this.close = function()

...
namespace Sys.Project.Common
{
    ...
    public class WebPageBase : System.Web.UI.Page
    {
        ...
        /// <returns></returns>
        public void JqueryMessager(UpdatePanel updatePanel, string title, string msg, Sys.Comm.MessageType msgType, string funName)
        {
            //System.Random rd = new Random();
            //msg = Escape(msg);
            string script = Sys.Comm.JqueryComm.ShowMessage(title, msg, msgType, funName);
        ...
        /// <param name="funName">回调函数名称</param>
        /// <returns></returns>
        public void JqueryMessager(UpdatePanel updatePanel, string msg, Sys.Comm.MessageType msgType, string funName)
        {
        ...
        /// <param name="msgType">对话框类型</param>
        /// <returns></returns>
        public void JqueryMessager(UpdatePanel updatePanel, string msg, Sys.Comm.MessageType msgType)
        {
            if (msgType == Sys.Comm.MessageType.error)
            {
                this.JqueryMessager(updatePanel, "错误", msg, msgType, null);
            }
            else if (msgType == Sys.Comm.MessageType.warning)
            {
        ...
        /// <param name="msgType">对话框类型</param>
        /// <returns></returns>
        public void JqueryMessager(UpdatePanel updatePanel, string title, string msg, Sys.Comm.MessageType msgType)
        {
        ...
        {
            this.JqueryMessager(updatePanel, "提示", msg, Sys.Comm.MessageType.info, null);
        }
        #endregion
        ...
        /// <param name="msgType">对话框类型</param>
        /// <returns></returns>
        public void JqueryMessager(Page page, string title, string msg, Sys.Comm.MessageType msgType, string funName)
        {
            string script = Sys.Comm.JqueryComm.ShowMessage(title, msg, msgType, funName);
        ...
        /// <param name="funName">回调函数名称</param>
        /// <returns></returns>
        public void JqueryMessager(Page page, string msg, Sys.Comm.MessageType msgType, string funName)
        {
        ...
        /// <param name="msgType">对话框类型</param>
        /// <returns></returns>
        public void JqueryMessager(Page page, string msg, Sys.Comm.MessageType msgType)
        {
        ...
        /// <param name="msgType">对话框类型</param>
        /// <returns></returns>
        public void JqueryMessager(Page page, string title, string msg, Sys.Comm.MessageType msgType)
        {
        ...
        {
            this.JqueryMessager(page, "提示", msg, Sys.Comm.MessageType.info, null);
        }
        #endregion
        ...
        protected String MainDataBaseName
        {
            get
            {
                ...
                {
                    mMainDataBaseName =  Sys.Com.Common .SystemWebFormulation.Parameter("MainDataBaseName");
                }
        ...
        private Operator CreateOperatorObj()
        {
            ...
            if (Request.Browser.Cookies)
            {
                System.Web.HttpCookie httpc = Request.Cookies[
                  Sys.Com.Common.SystemWebFormulation.Parameter("OperatorId")];
